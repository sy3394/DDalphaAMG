...
OPT_VERSION_FLAGS = $(CFLAGS) $(LIMEFLAGS) ${FABULOUSFLAGS} $(H5FLAGS) ${LAPACKFLAGS} ${EFENCEFLAGS} -DPARAMOUTPUT -DTRACK_RES -DBASE_LOOP_COUNT=4 -DOPENMP -DPROFILING  #-DHAVE_TM1p1 -DDEBUG
